...
$result = mysql_query("select id, title, author, tieba_follower, intro from book where category = $category_id order by tieba_follower desc limit ".(($page - 1) * $page_size).", $page_size");
